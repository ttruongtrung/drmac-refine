    ...
    <footer className="bg-white dark:bg-charcoal border-t border-gray-200 dark:border-charcoal-light mt-20 py-12 px-6 lg:px-12 text-gray-600 dark:text-gray-400 text-sm">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
        <div>
          ...
          <p>Premium Apple products & services.</p>
        </div>
        <div>
          <h4 className="text-black dark:text-white font-semibold mb-4">Shop</h4>
          <ul className="space-y-2">
            ...
            <li><a href="#" className="hover:text-black dark:hover:text-gold">Accessories</a></li>
          </ul>
        </div>
        <div>
        ...
        <div>
          <h4 className="text-black dark:text-white font-semibold mb-4">Legal</h4>
          <ul className="space-y-2">
            <li><a href="#" className="hover:text-black dark:hover:text-gold">Privacy Policy</a></li>
            <li><a href="#" className="hover:text-black dark:hover:text-gold">Terms of Service</a></li>
          </ul>
        </div>
      </div>
      <div className="max-w-7xl mx-auto mt-12 pt-8 border-t border-gray-200 dark:border-charcoal-light flex justify-between items-center">
        <p>&copy; {new Date().getFullYear()} Dr.Mac. All rights reserved.</p>
      </div>
    </footer>
  );
}
